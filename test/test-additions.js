...
AdditionsTest.prototype.testOlderThan = function()
{
	...
	// Regression
	assert("2.9.9".olderThan("2.9.10"), "2.9.9 is older than 2.9.10");
	assertFalse("2.9.10".olderThan("2.9.9"), "2.9.10 is not older than 2.9.9");
};
...
AdditionsTest.prototype.testStringTimes = function()
{
	assertEqual("*".times(3), "***", "String was not repeated the right number of times");
	assertEqual("*".times(1), "*", "String was not repeated the right number of times");
	assertEqual("ciao ".times(3), "ciao ciao ciao ", "String was not repeated the right number of times");
	assertEqual("ahem".times(1), "ahem", "String was not repeated the right number of times");
	assertEqual("*".times(0), "", "String was not repeated the right number of times");
	assertEqual("*".times('a'), "", "String was not repeated the right number of times");
};
...
AdditionsTest.prototype.testShellEscape = function()
{
	assertEqual("TIM".shellEscape(), "TIM", "Bad shell escaping");
	assertEqual("Vodafone Ireland".shellEscape(), "Vodafone\\ Ireland", "Bad shell escaping");
};
